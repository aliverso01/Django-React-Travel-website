...
function AccountFlow({
  ...
  const handleRemoveAllFromBasketHotel = () => {
    fetch(`http://localhost:8000/blog/hotelbasket/removeAll/`, {
      method: "DELETE",
      headers: {
  ...
  const handleRemoveAllFromBasketTicket = () => {
    ...
    fetch(`http://localhost:8000/blog/basket/removeAll/`, {
      method: "DELETE",
      headers: {
        "Content-Type": "application/json",
  ...
  const handleRemoveFromBasket = (itemId) => {
    fetch(`http://localhost:8000/blog/basket/${itemId}/`, {
      method: "DELETE",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  const handleRemoveFromBasketHotel = (itemId) => {
    fetch(`http://localhost:8000/blog/hotelbasket/${itemId}/`, {
      method: "DELETE",
      headers: {
        "Content-Type": "application/json",
      },
